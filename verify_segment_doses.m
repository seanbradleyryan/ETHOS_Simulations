...
dicomPath = '/mnt/weka/home/80030361/ETHOS_Simulations/EthosExports/1194203/Pancreas/Session_1/sct'; 
...
plot(zVec(15:80), zProfile_calc(15:80), 'b-', 'LineWidth', 2, 'DisplayName', 'Calculated');
hold on;
if hasRefDose
    zProfile_ref = squeeze(refDose(maxI, maxJ, :));
    plot(zVec(15:80), zProfile_ref(15:80), 'r--', 'LineWidth', 2, 'DisplayName', 'Reference');
end
