%% ETHOS IMRT Segment-by-Segment Dose Calculator (FIXED VERSION v2)
...
%     * MLC1 (proximal): 56 leaf pairs, boundaries at -145 to 145 mm (10mm spacing)
%     * MLC2 (distal): 58 leaf pairs, boundaries at -150 to 150 mm (offset by 5mm)
...
% MLC1 (proximal layer): 56 leaf pairs
% Boundaries: -145, -135, -125, ..., 135, 145 mm (10mm leaf width)
MLC1_NUM_PAIRS = 56;
MLC1_LEAF_WIDTH = 10;  % mm
MLC1_BOUNDARY_START = -145;  % mm
MLC1_BOUNDARY_END = 145;  % mm
MLC1_BOUNDARIES = (MLC1_BOUNDARY_START : MLC1_LEAF_WIDTH : MLC1_BOUNDARY_END)';

% MLC2 (distal layer): 58 leaf pairs
% Boundaries: -150, -140, -130, ..., 140, 150 mm (10mm leaf width, offset by 5mm)
MLC2_NUM_PAIRS = 58;
MLC2_LEAF_WIDTH = 10;  % mm
MLC2_BOUNDARY_START = -150;  % mm (5mm offset from MLC1)
MLC2_BOUNDARY_END = 150;  % mm
...
fprintf('  FIXED VERSION v2 - Independent Dual-Layer MLC Checking\n');
fprintf('==========================================================\n\n');
...
for idxID = 1:length(ids)
    for idxSession = 1:length(sessions)
        ...
        % Use a separate cache file for v2 segment data
        segmentCacheFile = fullfile(dicomCacheDir, 'segmentData_v2.mat');
        ...
        for beamIdx = 1:length(stf)
            ...
            % Check for cached beam dose (use v2 cache file)
